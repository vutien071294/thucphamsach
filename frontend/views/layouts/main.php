...
<html lang="vi" prefix="og: http://ogp.me/ns#" class="js no-svg">
    <head>
        ...
        <meta name="description" content="Thiết kế xây dựng nội thất">
        <meta name="keywords" content="Thiết kế,Công trình,Xây dựng,Thi công, Nội thất">
                        ...
                        <ul id="menu-menu-chinh" class="vietmoz-menu">
                            <?php foreach ($parent_product as $key => $value) { ?>
                                ...
                                <li id="menu-item-590" class="menu-item menu-item-type-post_type menu-item-has-children menu-item-object-page menu-item-590">
                                    <a href="#" style="padding-left: 30px;"><?php echo $value['title'] ?></a>
                                    <ul class="sub-menu">
                            ...
                            <li id="menu-item-590" class="menu-item menu-item-type-post_type menu-item-has-children menu-item-object-page menu-item-590">
                                <a href="#">Thương mại</a>
                                <ul class="sub-menu">
                                   <?php foreach ($trade as $key => $value) { ?>
                                        <li id="menu-item-627" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-627"><a href="<?php echo $base_url ?>trade?prm=<?php echo $value['id'] ?>"><?php echo $value['title'] ?></a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                            <li id="menu-item-590" class="menu-item menu-item-type-post_type menu-item-has-children menu-item-object-page menu-item-590">
                                <a href="#">Đầu tư</a>
                                <ul class="sub-menu">
                                   <?php foreach ($invest as $key => $value) { ?>
                                        <li id="menu-item-627" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-627"><a href="<?php echo $base_url ?>invest?prm=<?php echo $value['id'] ?>"><?php echo $value['title'] ?></a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                            <li id="menu-item-633" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-633"><a href="<?php echo $base_url ?>recruitment">Tuyển dụng</a></li>
                            ...
                            <ul id="menu-menu-chinh-1" class="vietmoz-m-menu">
                                ...
                                <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-626">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <?php 
                                        if ($key == 0) { ?>
                                            <li id="menu-item-590" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-626">
                                                <a href="#">Sản phẩm - thiết bị</a>
                                                <span class="dropdown-toggler glyphicon glyphicon-chevron-down"></span>
                                                <ul class="sub-menu">
                                                   <?php foreach ($sanpham as $key => $value) {?>
                                                        <li id="menu-item-627" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-627"><a href="<?php echo $base_url ?>product?prm=<?php echo $value['id'] ?>"><?php echo $value['title'] ?></a></li>
                                                    <?php } ?>
                                ...
                                <li id="menu-item-633" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-631"><a href="<?php echo $base_url ?>recruitment">Tuyển dụng</a></li>
