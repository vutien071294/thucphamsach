...
/* @var $searchModel backend\modules\contents\models\ConstructionSearch */
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($data) {
                    ...
                    return Html::img($base_url.'public/images/image_contruction/' . $data['url'],
            ...
            [
                ...
                'value' => function($row){
                    if($row['is_hot'] == 1){
                        ...
                        $name = 'Hoàn thành';
                    }else if($row['is_build'] == 1){
                        $name = 'Xây dựng';
                    }elseif ($row['is_noithat'] == 1) {
    ...
    $(document).ready(function () {
        ...
        $(".confirm_delete_btn").click(function(){
            ...
            if (id_delete) 
            {
                $.ajax({
                    method: 'POST',
                    url: '<?php echo $base_url ?>contents/construction/delete',
                    ...
                    success: function(result){
                        if (result == 'success') 
                        {
                            ...
                            $("#modal-success_delete").modal("hide");
                                location.replace('<?php echo $base_url ?>contents/construction');
                            }, 2000);
