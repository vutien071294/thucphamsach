...
/**
 * Product_typeSearch represents the model behind the search form about `backend\modules\product\models\Product_type`.
 */
class Product_typeSearch extends Product_type
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'parent_id', 'orders', 'create_by', 'update_by'], 'integer'],
            [['title', 'title_en', 'title_fr', 'description', 'body', 'slug', 'image_preset', 'image_url', 'image_title', 'image_alt', 'sorting_price', 'sorting_brand', 'sorting_res', 'sorting_channel', 'tags', 'create_time', 'update_time', 'seo_title', 'seo_keyword', 'seo_description', 'code'], 'safe'],
