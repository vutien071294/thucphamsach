       ...
       'id' => 'kv-grid-data',
        ...
        'columns' => [
            [ 
                ...
                'header'=>'STT',
                'contentOptions' => ['class'=>'word-wrap-new', 'style'=>'width:5%;',],
            ],

            [
                'attribute' => 'title',
                'header'=>'Tiêu đề',
                'contentOptions' => ['class'=>'word-wrap-new', 'style'=>'width:43%;',],
            ],
            ...
            'contentOptions' => ['class'=>'word-wrap-new text-center', 'style'=>'width:9%;',],
            'buttons' => [
    ...
    $(document).ready(function () {
        ...
        $(".confirm_delete_btn").click(function(){
            ...
            if (id_delete) 
            {
                $.ajax({
                    method: 'POST',
                    url: '<?php echo $base_url ?>product/dmsanpham/delete',
                    ...
                    success: function(result){
                        if (result == 'success') 
                        {
                            ...
                            $("#modal-success_delete").modal("hide");
                                location.replace('<?php echo $base_url ?>product/dmsanpham');
                            }, 2000);
